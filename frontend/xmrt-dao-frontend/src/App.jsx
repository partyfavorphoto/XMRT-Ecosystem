...
function App() {
  ...
  const { isConnected: walletConnected, connectWallet, loading: walletLoading } = useWallet();
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              ...
              <Button variant="outline" onClick={connectWallet} disabled={walletConnected || walletLoading}>
                {walletConnected ? 'Wallet Connected' : (walletLoading ? <Loader2 className="h-4 w-4 animate-spin" /> : 'Connect Wallet')}
              </Button>
            </div>
          </div>
        </div>
