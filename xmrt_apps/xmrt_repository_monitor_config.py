#!/usr/bin/env python3
"""
Configuration module for XMRT Repository Monitor
"""
...
class XMRTRepositoryMonitorConfig:
    XMRT_REPOSITORIES = [
        "XMRT-Ecosystem",
        "xmrtassistant",
        "xmrtcash",
    ...
    VERSION = "1.0.0"
    APPLICATION_NAME = "XMRT Repository Monitor"
...
config = XMRTRepositoryMonitorConfig()
