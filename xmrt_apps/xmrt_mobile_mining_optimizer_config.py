#!/usr/bin/env python3
"""
Configuration module for XMRT Mobile Mining Optimizer
"""
...
class XMRTMobileMiningOptimizerConfig:
    XMRT_REPOSITORIES = [
        "XMRT-Ecosystem",
        "xmrtassistant",
        "xmrtcash",
    ...
    VERSION = "1.0.0"
    APPLICATION_NAME = "XMRT Mobile Mining Optimizer"
...
config = XMRTMobileMiningOptimizerConfig()
